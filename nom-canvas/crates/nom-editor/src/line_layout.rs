...
impl LineLayout {
    pub fn new(len: usize, width: f32, height: f32) -> Self {
        Self { len, width, height, runs: Vec::new(), ascent: height * 0.8, descent: height * 0.2 }
    }
...
mod tests {
    ...
    fn line_layout_hit_test() {
        ...
        ll.runs.push(LayoutRun { start: 0, end: 10, x: 0.0, y: 0.0, width: 100.0, height: 20.0, font_id: 0, font_size: 14.0 });
