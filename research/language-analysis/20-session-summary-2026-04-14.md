...
- This doc's immediate predecessor: `8685626`. Latest HEAD is `8685626`.
- **Translation milestones**: 20 → **70 translations**, 14 → **57 paradigm families** (50-language-survey exceeded by 14%), 44% → **80% closure**, 30 → **43 wedges queued** (all W5-W50). 37 consecutive minimal-wedge / **29 consecutive 0-new-wedge** translations.
